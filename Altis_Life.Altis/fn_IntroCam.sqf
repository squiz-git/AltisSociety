...
*/
if (str player in ["cop_27","cop_26"]) exitWith {life_firstSpawn = false;};
private ["_camera", "_camDistance","_randCamX","_randCamY","_camTime"];
_camDistance = 1500;
_randCamX = 120 - floor(random 150);
_randCamY = 120 - floor(random 150);
_camTime = 7.6;// you can change the time for sure, I adjusted mine to the intro music
